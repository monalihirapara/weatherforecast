            ...
            <div class="w-full max-w-sm">
                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap items-center">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-gray-100 font-bold w-full   py-3 px-4 rounded focus:outline-none focus:shadow-outline">
                                {{ __('Login') }}
                            </button>
                ...
                @if (Route::has('register'))
                    <p class="w-full text-sm text-center text-gray-200 mt-8 -mb-4 tracking-wide">
                        ...
                        <a class="text-gray-300 hover:text-gray-500 border-b" href="{{ route('register') }}">
                            {{ __('Register') }}
                        </a>
                    </p>
                @endif
